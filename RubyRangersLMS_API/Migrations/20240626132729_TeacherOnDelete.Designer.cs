...
namespace RubyRangersLMS_API.Migrations
{
    ...
    [Migration("20240626132729_TeacherOnDelete")]
    partial class TeacherOnDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RubyRangersLMS_API.Identity.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RubyRangersLMS_API.Identity.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RubyRangersLMS_API.Identity.Student", b =>
                {
                    b.HasBaseType("RubyRangersLMS_API.Identity.ApplicationUser");
            ...
            modelBuilder.Entity("RubyRangersLMS_API.Identity.Teacher", b =>
                {
                    b.HasBaseType("RubyRangersLMS_API.Identity.ApplicationUser");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("RubyRangersLMS_API.Identity.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("RubyRangersLMS_API.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RubyRangersLMS_API.Entities.Course", b =>
                {
                    b.HasOne("RubyRangersLMS_API.Identity.Teacher", "Teacher")
                        .WithMany("Courses")
